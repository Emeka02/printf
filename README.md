# _printf
```_printf``` is a custom implementation of the C programming function ```printf```. This project is an application of the C programming knowledge that [ALX School](https://www.alxafrica.com/) cohort 8 students have learned.
...
## Authors
[Oluwaseyi Egunjobi](https://github.com/seyistry) | [Emeka Stanley](https://github.com/Emeka02)
